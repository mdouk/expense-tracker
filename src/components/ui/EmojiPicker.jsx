...
const EmojiPicker = ({ isOpen, onClose, onSelect, currentEmoji }) => {
    ...
    const handleNativeEmojiInput = (e) => {
        ...
        // Extract the first emoji from input
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
            ...
            <div className="relative z-10 w-full max-w-xs overflow-hidden rounded-3xl bg-white dark:bg-zinc-800 shadow-2xl ring-1 ring-black/5 dark:ring-white/10 animate-in zoom-in-95 duration-200">
                <div className="flex items-center justify-between border-b border-zinc-100 dark:border-zinc-700 px-4 py-3">
                    ...
                    <button 
                        onClick={onClose} 
                        className="rounded-full p-2 min-w-[40px] min-h-[40px] flex items-center justify-center text-zinc-400 hover:bg-zinc-100 dark:hover:bg-zinc-700 hover:text-zinc-900 dark:hover:text-zinc-100 transition-colors"
                    >
                        <X className="h-5 w-5" />
                    </button>
                </div>
                ...
                <div className="p-3 border-b border-zinc-100 dark:border-zinc-700">
                    <div 
                        ...
                        className="flex items-center gap-2 rounded-xl bg-zinc-100 dark:bg-zinc-700 px-3 py-2 cursor-text"
                    >
                    ...
                    <p className="mt-1.5 text-[11px] text-zinc-400 text-center">Use your device's emoji keyboard</p>
                </div>
